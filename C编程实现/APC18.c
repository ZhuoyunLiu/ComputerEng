...
float data[R][Y];
char province[R][14]={"Beijing","Tianjing","Hebei","Shanxi","Inner Mongolia","Liaoning","Jilin","Heilongjiang","Shanghai","Jiangsu","Zhejiang","Anhui","Fujian","Jiangxi","Shandong","Henan","Hubei","Hunan","Guangdong","Guangxi","Hainan","Chongqin","Sichuan","Guizhuo","Yunnan","Tibet","Shanxi","Gansu","Qinghai","Ningxia","Xinjiang"}; 
...
int main()
{
	...
	printf("Show the economic data of 31 economic region of China in 10 years:\n ");
	for(i=0;i<R;i++) 
	{
		printf("%s ",province[i]);
		for(j=0;j<Y;j++)
